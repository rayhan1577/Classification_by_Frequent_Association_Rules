...
def test_uci():
    ...
    for dataset_name in data:
        ...
        for i in range(20):
            ...
            for i in range(100):
                try:
                    ...
                    sample, sample_test, temp= subsample(X_train, X_test,15)
                    #print("temp",temp)
                    temp2=[]
        ...
        print("average accuracy:",sum(total_acc)/20, "average precision:",sum(total_pre)/20, "average recall:",sum(total_rec)/20, "estimator", estimator/20 )
